...
|---|---|---|
| `ecs_console_instance_running.png` | The Alibaba Cloud ECS console: instance `i-t4n1i5p7bz4ypj122e6q` (`ledgerpilot-agent`), **Running**, Singapore (`ap-southeast-1`), public IP `47.84.116.56`, serving [https://ledgerpilot.jonathanandrei.com](https://ledgerpilot.jonathanandrei.com). This is the box the backend runs on, provisioned by [`scripts/deploy_ecs.py`](../../scripts/deploy_ecs.py). | [`docs/ecs_proof.txt`](../ecs_proof.txt) |
